...
export const dummyData = [
    ...
    },
    {
        ...
        possibleAnswers: [
            {
                option:'Sunt esse in sit nostrud labore. Sunt qui veniam laboris irure commodo adipisicing do. Et nisi aute nisi esse adipisicing deserunt quis magna irure. Officia cupidatat ullamco proident pariatur ipsum commodo laborum amet minim anim consequat dolore labore. Culpa eu officia deserunt labore id aliquip do amet esse adipisicing eu pariatur. Officia amet nulla sint quis adipisicing do adipisicing minim duis. Pariatur proident tempor nisi est pariatur.',
                id: uuid(),
                selected: false,
            },
            {
                option: 'Sint ipsum ex est mollit excepteur laborum cupidatat ea. Ad anim elit qui culpa incididunt. Magna magna cupidatat laborum laborum ex fugiat dolor. Velit id labore id sunt Lorem nulla commodo.',
                id: uuid () ,
                selected: false,
            },
            {
                option: 'Do laboris nisi irure anim cillum nulla qui elit ut. Nisi non et consequat incididunt qui velit eiusmod labore laboris elit. Duis labore pariatur culpa excepteur ea elit exercitation culpa aute. Excepteur duis nulla Lorem laborum adipisicing commodo laboris amet do ut officia. Officia in aliquip esse aliquip duis laborum magna ipsum ut. Sit ut aliquip enim nostrud mollit irure. Nulla enim duis culpa officia est labore exercitation non quis occaecat commodo qui minim aliquip.',
                id: uuid(),
                selected: false,
            },
        ],
